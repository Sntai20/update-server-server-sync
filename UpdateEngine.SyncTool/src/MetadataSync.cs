...
namespace UpdateEngine.SyncTool
{
    ...
    class MetadataSync
    {
        ...
        {
            UpdateEngine.Metadata.Source.Endpoint upstreamEndpoint;
            if (!string.IsNullOrEmpty(options.UpstreamEndpoint))
            {
                upstreamEndpoint = new UpdateEngine.Metadata.Source.Endpoint(options.UpstreamEndpoint);
            }
            else
            {
                upstreamEndpoint = UpdateEngine.Metadata.Source.Endpoint.Default;
            }
        ...
        {
            var upstreamEndpoint = string.IsNullOrEmpty(options.UpstreamEndpoint) ? UpdateEngine.Metadata.Source.Endpoint.Default : new UpdateEngine.Metadata.Source.Endpoint(options.UpstreamEndpoint);
