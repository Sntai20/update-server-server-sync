...
public class WebServiceFunctions
{
    ...
    private readonly Microsoft.PackageGraph.MicrosoftUpdate.Endpoints.ServerSync.ReportingWebService reportingService;
    ...
    public WebServiceFunctions(
        ...
        Microsoft.PackageGraph.MicrosoftUpdate.Endpoints.ServerSync.ReportingWebService reportingService)
    {
        this.logger = logger;
