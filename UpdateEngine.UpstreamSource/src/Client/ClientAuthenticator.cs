...
namespace UpdateEngine.Metadata.Source;
...
class ClientAuthenticator
{
    ...
    private async Task<Microsoft.UpdateServices.WebServices.DssAuthentication.AuthorizationCookie> GetAuthorizationCookie(AuthPlugInInfo authInfo)
    {
        var httpBinding = new System.ServiceModel.BasicHttpBinding();
...
accountName = AccountName
    ...
    private async Task<Cookie> GetServerAccessCookie(Microsoft.UpdateServices.WebServices.DssAuthentication.AuthorizationCookie authCookie)
    {
        var httpBinding = new System.ServiceModel.BasicHttpBinding();
        var upstreamEndpoint = new System.ServiceModel.EndpointAddress(UpstreamEndpoint.ServerSyncURI);
        if (upstreamEndpoint.Uri.Scheme.Equals("https", StringComparison.OrdinalIgnoreCase))
        ...
        var cookieRequest = new GetCookieRequest
        {
            ...
            {
                authCookies = new Microsoft.UpdateServices.WebServices.ServerSync.AuthorizationCookie[] 
                { 
        ...
        cookieRequest.GetCookie.authCookies = new Microsoft.UpdateServices.WebServices.ServerSync.AuthorizationCookie[] { new Microsoft.UpdateServices.WebServices.ServerSync.AuthorizationCookie() };
