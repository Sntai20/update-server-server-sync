...
public class UnifiedSyncFunctions
{
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post")] HttpRequestData req)
    {
        ...
        try
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (this.contentStore is UpdateEngine.Metadata.Storage.Local.FileSystemContentStore)
                {
    ...
    /// </summary>
    private string GetExpectedMarkerPath(UpdateEngine.Metadata.ObjectModel.IContentFile file)
    {
    ...
    /// </summary>
    private async Task<bool> CheckMarkerExistsAsync(UpdateEngine.Metadata.ObjectModel.IContentFile file)
    {
