...
builder.Services.AddHostedService<UpdateEngine.WorkerService.Workers.SyncWorker>();
builder.Services.AddHostedService<UpdateEngine.WorkerService.Workers.HealthCheckWorker>();
