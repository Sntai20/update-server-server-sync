...
using MicrosoftUpdateFunctions.Tests.Infrastructure;
using System.Net;
using Xunit;

namespace MicrosoftUpdateFunctions.Tests.Integration;
...
/// </summary>
public class HybridIntegrationTests : IClassFixture<MicrosoftUpdateTestFixture>
{
    private readonly MicrosoftUpdateTestFixture _fixture;

    public HybridIntegrationTests(MicrosoftUpdateTestFixture fixture)
    {
        _fixture = fixture;
    }
